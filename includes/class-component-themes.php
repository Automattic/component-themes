...
class Component_Themes_Plugin {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Component_Themes_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'component-themes';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Component_Themes_Loader. Orchestrates the hooks of the plugin.
	 * - Component_Themes_i18n. Defines internationalization functionality.
	 * - Component_Themes_Admin. Defines all hooks for the admin area.
	 * - Component_Themes_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Component_Themes_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Component_Themes_Loader    Orchestrates the hooks of the plugin.
	 */
